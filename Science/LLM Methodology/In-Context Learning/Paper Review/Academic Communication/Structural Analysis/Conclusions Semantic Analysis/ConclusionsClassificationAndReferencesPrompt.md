...
* If a 'Conclusions' section *is* identified from the full manuscript, the analysis proceeds through all phases (1, 2, 3, 4, and 5). The final output will be a structured report. This report will begin with:
...
* After the completion of the detailed analysis provide at the very end a clear "Summary" section with a concise bullet list clearly indicating all items (including clear source location) that cannot be clearly substantiated and should be verified by a human. Each item to be verified (such as numerical quantity, material or method detail, etc.) should have a dedicated bullet for clear inspection by a human. 
