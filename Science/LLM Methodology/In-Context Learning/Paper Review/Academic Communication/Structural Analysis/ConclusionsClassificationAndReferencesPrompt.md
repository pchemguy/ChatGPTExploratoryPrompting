...
* After the completion of the detailed analysis provide at the very end a clear "Summary" section with a concise bullet list clearly indicating all items (including clear source location) that cannot be clearly substantiated and should be verified by a human.
