...
1. **Advanced Prompt Architecture & Interaction**
    ...
    - **Zero-Code Accessibility:** Entirely prompt-driven, requiring no programming, API access, or specialized software installs.
2. **Deep Methodological Scrutiny (A Priori Evaluation)**
...
4. **Information Extraction, Inference, and Integration**
